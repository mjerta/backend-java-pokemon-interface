...
public class PokemonGymImpl implements PokemonGym {
  ...
  public void enteredTheGym(PokemonTrainer player1) {
    ...
    System.out.println(Main.ANSI_RED + gymOwner.getName() + Main.ANSI_RESET + ": Hello stranger, I'm " + gymOwner.getName() +
      ", the owner of this gym. Who are you?");
    System.out.println(
      Main.ANSI_GREEN + player1.getName() + Main.ANSI_RESET + ": I'm " + player1.getName() + " and i'm here to challenge you for a battle");
  ...
  public void gymOwnerAttacks(Pokemon gymPokemon, Pokemon pokemon, PokemonGymOwner owner) {
    ...
    switch (gymPokemon.getType()) {
      case "fire" -> {
        fire = new FirePokemon(gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(),
          gymPokemon.getSound());
      ...
      case "water" -> {
        water = new WaterPokemon(gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(),
          gymPokemon.getSound());
      ...
      case "grass" -> {
        grass = new GrassPokemon(gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(),
          gymPokemon.getSound());
      ...
      default -> {
        electric = new ElectricPokemon(gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(),
          gymPokemon.getSound());
